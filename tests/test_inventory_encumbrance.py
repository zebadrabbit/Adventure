...
import pytest
from tests.factories import create_user, create_character, ensure_item, create_instance
...
def test_stacking_and_encumbrance(client):
    with app.app_context():
        ...
        c = create_character(u, 'CarryOne', 'fighter', items=[])
    ...
    loot_ids = [l['id'] for l in data['loot']]
    results = []
    for lid in loot_ids:
