...
class _Logger:
    ...
    def debug(self, **fields): self._log('debug', 10, **fields)
    def info(self, **fields): self._log('info', 20, **fields)
    def warn(self, **fields): self._log('warn', 30, **fields)
    def error(self, **fields): self._log('error', 40, **fields)
