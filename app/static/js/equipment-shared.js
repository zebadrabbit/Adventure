 ...
 *
 * Retained (restored after a brief deletion) only because equipment.js on
 * /adventure still depends on it -- equipment-panel.js folded its own copy
 * of encumbranceView/gearBonusText in directly and no longer loads this
 * file. That leaves the same logic in two places for one task's length,
 * which is deliberate: this file and equipment.js are deleted together in
 * Task 2, along with the script tags that load them, and that is where
 * this deletion always belonged.
 */
(function () {
  "use strict";
