...
-- Defensive Affixes
INSERT OR IGNORE INTO procedural_affix (affix_id, name, slot, affected_stat, min_value, max_value, scaling_per_level, rarity_weight, allowed_item_types, tags, notes)
VALUES
